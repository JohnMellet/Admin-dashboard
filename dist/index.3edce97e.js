...
})({"8udFE":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "fc448a593edce97e";
"use strict";
...
},{}],"8K9da":[function(require,module,exports) {
...
(async function() {
    ...
    new (0, _autoDefault.default)(document.getElementById("monthlyStats"), {
        type: "bar",
        data: {
            labels: data.map((row)=>row.year),
            datasets: [
    ...
    new (0, _autoDefault.default)(document.getElementById("newChart"), {
        type: "bar",
        data: {
...
},{}]},["8udFE","8K9da"], "8K9da", "parcelRequire30ab")

//# sourceMappingURL=index.3edce97e.js.map
